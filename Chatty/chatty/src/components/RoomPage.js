...
function RoomPage(props) {
    ...
    const handleJoinRoom = async()=> {
        loaderDispatch(setLoading({loadingvalue:true,loadingtext:"Wait while we set you up!"}));
        setTimeout(() => {
            loaderDispatch(setLoading({loadingvalue:false, loadingtext:""})); 
    ...
    return (
        <div style ={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", textAalign:"center", height:"100vh"}}>   
            
            <div className='text-container' style ={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center",textAlign:"center"}}>
            <Avatar src = {avatar} className='avatar' sx = {{height:"100px" , width: "100px", background:"smokewhite"}} />
            <h1 className='simpletext' style = {{margin:0   }}>Hello {username} </h1>
            <p className= 'sub-title'>This is a temporary username which is valid only for this session.</p>
            </div>
            {createPressed ===false && joinPressed===false?  <div className= 'create-join-container' style ={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center",textAlign:"center"}}>
...
function JoinComp(props) {
    ...
    return (
        ...
        <p className='sub-title'  style = {{marginTop:0, marginBottom:10}}>Enter the roomcode, ask your friend for it.</p>
            <input className= 'login-input' placeholder='Room Code' onChange= {handleChange}></input>  
        </div>
